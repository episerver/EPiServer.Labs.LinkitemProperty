...
Set-Location src\AlloyMvcTemplates\modules\_protected\episerver-labs-linkitem-property
ZipCurrentModule -moduleName episerver-labs-linkitem-property
Set-Location $workingDirectory
Start-Process -NoNewWindow -Wait -FilePath $nuget -ArgumentList "pack", "$workingDirectory\build\packaging\EPiServer.Labs.LinkItemProperty.nuspec", "-Version $assemblyFileVersion", "-Properties configuration=Release", "-BasePath ./", "-Verbosity detailed"
