...
$SiteRoot = "e:\LinkItemProperty"
$IISSiteName = "Default Web Site\LinkItemProperty"
...
function Transform-Config {
    ...
    Update-EPiXmlFile -TargetFilePath "$SitePath\wwwroot\Web.config" -ModificationFilePath "$TmpPackageFolder\Setup\Alloy.Sample.LinkItemProperty.web.config.transform" -Replaces "{basePath}=$SitePath\appData;{DbServer}=$DbServer;{DbDatabase}=$SiteName;{DbUserName}=$DbSiteUser;{DbPassword}=$DbSitePassword;"
}
